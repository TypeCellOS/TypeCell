...
<!-- An Open Source, local-first,
        collaborative document and live programming environment. -->

<template>
  <header>
    <div class="header-content">
      <h1>Interactive documents. <strong>Reimagined.</strong><br /></h1>
    ...
    <div class="header-media">TODO</div>
    <!-- features
sponsors
