...
const SIDEBAR_DEFAULT = [
  {
    text: "Philosophy",
    items: [
      { text: "Aligned software", link: "/philosophy/introduction" },
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [{ text: "Documentation", link: "/docs/introduction" }, { text: "Philosophy", link: "/philosophy/introduction" }],
    sidebar: {
      "/docs/": SIDEBAR_DEFAULT,
      "/philosophy/": SIDEBAR_DEFAULT,
