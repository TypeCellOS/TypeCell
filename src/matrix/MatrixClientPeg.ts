...
if (!(window as any).mxMatrixClientPeg) {
  (window as any).mxMatrixClientPeg = new _MatrixClientPeg();
}

export const MatrixClientPeg = (window as any).mxMatrixClientPeg;
